...
const SERVICES_EN = [
  ...
  { name: "Automation (n8n & Script)" },
  { name: "AI Coding & Integrations" },
] as const satisfies { name: string }[];

const SERVICES_VI = [
  { name: "Vận hành SOC & SIEM" },
  { name: "Phân tích Log & Ứng cứu" },
  { name: "DevOps & Hạ tầng mạng" },
  { name: "Tự động hóa (n8n & Script)" },
  { name: "Lập trình AI & Tích hợp" },
] as const satisfies { name: string }[];
